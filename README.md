...
The aim of this project is to  build the client-side for an application called listapeli using Angular based on its existing server-side code (REST API and database), with supporting documentation.
...
https://nine-chairs.github.io/myFlix-Angular-client/welcome
